...
import com.watabou.unbreakablepixeldungeon.Rankings;
...
import com.watabou.unbreakablepixeldungeon.windows.WndError;
import com.watabou.unbreakablepixeldungeon.windows.WndRanking;
...
public class RankingsScene extends PixelScene {
	...
	public void create() {
		...
		if (Rankings.INSTANCE.records.size() > 0) {
			...
			float rowHeight = UnbreakablePixelDungeon.landscape() ? ROW_HEIGHT_L : ROW_HEIGHT_P;
