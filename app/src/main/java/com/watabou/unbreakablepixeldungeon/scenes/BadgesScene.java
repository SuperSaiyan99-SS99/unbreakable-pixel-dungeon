...
import com.watabou.unbreakablepixeldungeon.effects.BadgeBanner;
...
import com.watabou.unbreakablepixeldungeon.windows.WndBadge;
...
public class BadgesScene extends PixelScene {
	...
	public void create() {
		...
		int pw = (int)Math.min( w, (UnbreakablePixelDungeon.landscape() ? MIN_WIDTH_L : MIN_WIDTH_P) * 3 ) - 16;
		int ph = (int)Math.min( h, (UnbreakablePixelDungeon.landscape() ? MIN_HEIGHT_L : MIN_HEIGHT_P) * 3 ) - 32;
