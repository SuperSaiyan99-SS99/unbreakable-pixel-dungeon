...
import com.watabou.unbreakablepixeldungeon.effects.Fireball;
import com.watabou.unbreakablepixeldungeon.ui.Archs;
import com.watabou.unbreakablepixeldungeon.ui.ExitButton;
import com.watabou.unbreakablepixeldungeon.ui.PrefsButton;
...
public class TitleScene extends PixelScene {
	...
	public void create() {
		...
		float height = title.height + 
			(UnbreakablePixelDungeon.landscape() ? DashboardItem.SIZE : DashboardItem.SIZE * 2);
		...
		DashboardItem btnBadges = new DashboardItem( TXT_BADGES, 3 ) {
			...
			protected void onClick() {
				UnbreakablePixelDungeon.switchNoFade( BadgesScene.class );
			}
		};
		add( btnBadges );
		...
		DashboardItem btnAbout = new DashboardItem( TXT_ABOUT, 1 ) {
			@Override
			protected void onClick() {
				UnbreakablePixelDungeon.switchNoFade( AboutScene.class );
			}
		};
		add( btnAbout );
		...
		DashboardItem btnHighscores = new DashboardItem( TXT_HIGHSCORES, 2 ) {
			@Override
			protected void onClick() {
				UnbreakablePixelDungeon.switchNoFade( RankingsScene.class );
			}
		};
		add( btnHighscores );
