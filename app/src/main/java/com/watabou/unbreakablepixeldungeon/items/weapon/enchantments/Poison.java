 ...
 */
package com.watabou.unbreakablepixeldungeon.items.weapon.enchantments;
...
public class Poison extends Weapon.Enchantment {
	...
	public boolean proc( Weapon weapon, Char attacker, Char defender, int damage ) {
		...
		if (Random.Int( level + 3 ) >= 2) {
			...
			Buff.affect( defender, com.watabou.unbreakablepixeldungeon.actors.buffs.Poison.class ).
				set( com.watabou.unbreakablepixeldungeon.actors.buffs.Poison.durationFactor( defender ) * (level + 1) );
